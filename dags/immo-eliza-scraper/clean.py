...
# Define o caminho base relativo ao diretório do DAG no Airflow
dag_directory = os.path.join(os.environ['AIRFLOW_HOME'], 'dags', 'immo-eliza-scraper')

# Caminho para o arquivo CSV raw
raw_csv_path = os.path.join(dag_directory, 'Data', 'raw', 'final_raw.csv')
...
cleaned_directory = os.path.join(dag_directory, 'Data', 'cleaned')
